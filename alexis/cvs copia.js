...
await consumirCSV('http://10.1.64.119:6060/api/v1/cube/get/dimension/?f=equipment');
console.log("***************************************");
console.log("***************************************");
console.log("***************************************");
console.log("***************************************");
await consumirCSV('http://10.1.64.119:6060/api/v1/cube/get/dimension/?f=statusdetail');
console.log("***************************************");
console.log("***************************************");
